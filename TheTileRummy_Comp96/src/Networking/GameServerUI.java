...
import static core.Settings.getSTRATEGY_1;
import static core.Settings.getSTRATEGY_2;
import static core.Settings.getSTRATEGY_3;
 ...
 * @author Comp96
 */
public class GameServerUI extends javax.swing.JFrame implements TimerListner {
    ...
    /**
     * Creates new form GameServerUI
     */
    public GameServerUI() throws IOException {
        initComponents();
        setResizable(false);
    ...
    private void Handshake_with_client() throws IOException {
        ...
        while (true) {
            ...
            if (choice == 1 || choice == 2) {
                ...
                JOptionPane.showMessageDialog(null, "Choose Players Type\n1- Human\n2- AI", "Wrong Input", JOptionPane.WARNING_MESSAGE);
            }
        }
        switch (choice) {
            case 1: {
                ...
                Player p1 = new Human_Player(JOptionPane.showInputDialog("Enter Name of Player ").toUpperCase());
                players.add(p1);
                break;
            }
            case 2: {
        ...
        jTextArea_PlayersPlaying.setText(str);
        numOfPlayers++;
    ...
    public void initServer(int port) {
        ...
        try {
            ...
            while (flag) {
                ...
                out.writeUTF("Currently there are " + numOfPlayers + " players");
    ...
    private void initComponents() {
        ...
        jTextArea_PlayersPlaying = new javax.swing.JTextArea();
        ...
        jLabel4.setText("Players Playing");
        ...
        jTextArea_PlayersPlaying.setEditable(false);
        jTextArea_PlayersPlaying.setColumns(20);
        jTextArea_PlayersPlaying.setRows(5);
        jScrollPane5.setViewportView(jTextArea_PlayersPlaying);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameServerUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    GameServerUI obj = new GameServerUI();
                    obj.setVisible(true);
                    ...
                    Logger.getLogger(GameServerUI.class.getName()).log(Level.SEVERE, null, ex);
                }
    ...
    private javax.swing.JTextArea jTextArea_PlayersPlaying;
    ...
    public class ClientHandler extends Thread {
        ...
        public void run() {
            try {
                ...
                if (numOfPlayers >= 2) {
                    out.writeUTF("There are now " + numOfPlayers + " players");
                    for (Player p : players) {
                        p.register(p);
